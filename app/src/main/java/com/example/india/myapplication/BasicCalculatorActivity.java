...
import static com.example.india.myapplication.R.id.result;
...
public class BasicCalculatorActivity extends AppCompatActivity {
    ...
    public void doCalcute(View view) throws ScriptException {
        ...
        expressionString.setText(((Integer) result));
