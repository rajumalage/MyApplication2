...
public class Calc extends Activity implements OnItemSelectedListener{
    ...
    ImageView iv1;
    Spinner spinOps;
    String[] ops={"Choose operation","ADD","SUB","MUL","DIV","MOD"};
    String opselected;
    double a, b, c;
    private OnClickListener myClickListener = new OnClickListener()
    {
        public void onClick(View v) {
            ...
            if (opselected=="ADD"){c=a+b; tv1.setText(Double.toString(c));}
            else if (opselected=="SUB"){c=a-b; tv1.setText(Double.toString(c));}
            else if (opselected=="MUL"){c=a*b; tv1.setText(Double.toString(c));}
            else if (opselected=="DIV"){c=a/b; tv1.setText(Double.toString(c));}
            else if (opselected=="MOD"){c=a%b; tv1.setText(Double.toString(c));}
